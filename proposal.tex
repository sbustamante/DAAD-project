...
between the spin of galaxies and gaseous filaments above redshift one. They 
found a redshift-dependent stellar mass threshold above which high-mass 
galaxies are misaligned with filaments, while low-mass galaxies are aligned. On 
the other hand, \citet{Hahn10} also studied this problem by mean of a 
\texttt{RAMSES} simulation. They found a completely different result, high-mass 
galaxies are aligned while low-mass galaxies are misaligned with their embedding 
filaments. Another important problem related to highly efficient star forming 
galaxies at high-redshifts was studied by \citet{Dekel09} through the 
